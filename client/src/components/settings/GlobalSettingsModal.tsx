  ...
  return (
    <div className="flex flex-col gap-4 py-2">
      ...
      <Typography variant="body-small" className="text-label-mid leading-relaxed">
        A full-featured API testing tool built with React, TypeScript, and the US Bank Shield design system.
      ...
      <div className="flex flex-col gap-2 mt-2">
        ...
        <div className="flex justify-between text-[13px]">
          <span className="text-label-muted">Design System</span>
          <span className="text-label-mid">US Bank Shield</span>
        </div>
        <div className="flex justify-between text-[13px]">
          <span className="text-label-muted">Storage</span>
          <span className="text-label-mid">localStorage</span>
        </div>
        <div className="flex justify-between text-[13px]">
          <span className="text-label-muted">Build Date</span>
          <span className="text-label-mid">February 2026</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <Modal open={open} onOpenChange={onClose}>
      <ModalContent className="max-w-[680px]">
        ...
        <div className="flex gap-6 border-b border-utility-subdued -mx-6 px-6 mt-1">
          {TABS.map(tab => (
            <button
              key={tab.id}
        ...
        <div className="min-h-[320px] pt-2 max-h-[60vh] overflow-y-auto">
